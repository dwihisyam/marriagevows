...
<body class="bg" style="color:#96327D;background-image: url('<?= base_url('assets/') ?>img/background-all.png')">
    ...
    <header class="w3-display-container w3-wide bgimg" id="home" style="overflow-x:hidden;">
        <div style="position:absolute;background-color: rgba(255,255,255,0.5);width: 100%;height: 100%;">
        </div>
        <div class="w3-display-middle w3-center" style="position:absolute;">
            <img src="<?= base_url('assets/') ?>img/background-home.png" alt="">
        </div>
        <div class="w3-display-middle w3-center" style="color:#96327D">
    ...
    <!-- About / Jane And John -->
    <div class="w3-container w3-padding-64 w3-center page" id="about">
        <div class="w3-content">
            <h1 class="mb-5"><b>About</b></h1>
            <div class="row">
                <div class="col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine">
                    <img width="60%" class="img-fluid mb-3" src="<?= base_url('assets/') ?>img/template2/foger.jpg" alt="" style="border-radius:50%">
                ...
                <div class="col-md-6" data-aos="fade-left" data-aos-easing="ease-in-sine">
                    <img width="60%" class="img-fluid mb-3" src="<?= base_url('assets/') ?>img/template2/tyas.jpg" alt="" style="border-radius:50%">
    ...
    <div class="w3-container w3-padding-64 w3-center page" id="ceremony">
        <div class="w3-content">
            ...
            <div data-aos="zoom-out" class="text-center mx-auto mb-5 p-3" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.1);width:90%;">
                <h3 style="font-weight:bold;">Until we getting married</h3>
                <div class="row my-4">
                    <div class="row mx-auto countdown">
                        <div class="mx-5 p-2" style="width:120px;height:120px;background-color:rgba(255,255,255,0.7);border-radius:50%;box-shadow:0px 0px 5px rgba(0,0,0,0.1)">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-5">
                    <div class="p-5" style="border-radius:50%;background-color:rgba(255,255,255,0.7);box-shadow:0px 0px 5px rgba(0,0,0,0.1)">
                        <div>
                            <img width="50%" class="img-fluid mb-3" src="<?= base_url('assets/') ?>img/progress-1.png" alt="">
                        </div>
                        <div>
                            <h4>Marriage</h4>
                ...
                <div class="col-md-6 mt-5">
                    <div class="p-5" style="border-radius:50%;background-color:rgba(255,255,255,0.7);box-shadow:0px 0px 5px rgba(0,0,0,0.1)">
                        <div>
                            <img width="50%" class="img-fluid mb-3" src="<?= base_url('assets/') ?>img/progress-2.png" alt="">
                        </div>
                        <div>
    ...
    <header class="w3-display-container w3-wide bgimg2" id="quotes">
        <div style="position:absolute;background-color: rgba(255,255,255,0.5);width: 100%;height: 100%; top:0%;">
        </div>
        <div class="w3-center w3-padding-64">
            <div class="w3-content">
                <div class="multiple-items2 mx-auto" style="width:80%;color:#96327D;">
                    <div>
                        <h1 class="mb-5"><b>Quotes</b></h1>
                        <h1 class="mb-4" style="font-family:'Great Vibes', cursive">Happy is the man who finds a true friend, and far happpier is he who finds that true friend in his wife</h1>
                        -Franz Schubert-
                    </div>
                    <div>
                        <h1 class="mb-5"><b>Quotes</b></h1>
                        <h1 class="mb-4" style="font-family:'Great Vibes', cursive">Marriage is like a golden ring in a chain, whose beginning is a glance and whose ending is eternity.</h1>
                        -Khalil Gibran-
                    </div>
                    <div>
                        <h1 class="mb-5"><b>Quotes</b></h1>
                        <h1 class="mb-4" style="font-family:'Great Vibes', cursive">A happy marriage is a long conversation which always seems too short.</h1>
                        -Andre Maurois-
                    </div>
                </div>
            </div>
    ...
    <!-- Gallery -->
    <div class="w3-container w3-padding-64 w3-center page" id="gallery">
        <div class="w3-content">
            <h1 class="mb-5"><b>Gallery</b></h1>
            <div class="row my-5 gallery">
                <div data-aos="zoom-in" class="col-md-4 img-gallery">
                    <a href="<?= base_url('assets/') ?>img/template2/fogertyas.jpg" style="color:white">
                        <img class="mx-auto my-3" src="<?= base_url('assets/') ?>img/template2/fogertyas.jpg" alt="">
                    </a>
                </div>
                <div data-aos="zoom-in" class="col-md-4 img-gallery">
                    <a href="<?= base_url('assets/') ?>img/template2/fogertyas1.jpg" style="color:white">
                        <img class="mx-auto my-3" src="<?= base_url('assets/') ?>img/template2/fogertyas1.jpg" alt="">
                    </a>
                </div>
                <div data-aos="zoom-in" class="col-md-4 img-gallery">
                    <a href="<?= base_url('assets/') ?>img/template2/fogertyas3.jpg" style="color:white">
                        <img class="mx-auto my-3" src="<?= base_url('assets/') ?>img/template2/fogertyas3.jpg" alt="">
                    </a>
                </div>
                <div data-aos="zoom-in" class="col-md-4 img-gallery">
                    <a href="<?= base_url('assets/') ?>img/template2/fogertyas3.jpg" style="color:white">
    ...
    <!-- Footer -->
    <footer class="w3-center w3-padding-16 text-white" style="background-color:#96327D">
